...
public class AuthenticationEndpoint {
  ...
  @ApiOperation(
      value = "Get some valid authentication tokens",
  ...
  @ApiOperation(
      value = "Get information about a specific authentication token",
      authorizations = {@Authorization(value = "apiKey")})
  ...
  @ApiOperation(
      value = "Get information about the current users authentication token",
      authorizations = {@Authorization(value = "apiKey")})
