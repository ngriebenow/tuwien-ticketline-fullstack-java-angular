...
public class HeaderTokenAuthenticationProvider implements AuthenticationProvider {
  ...
  public HeaderTokenAuthenticationProvider(
    ...
    Assert.notNull(
        headerTokenAuthenticationService, "headerTokenAuthenticationService cannot be null");
  ...
  public Authentication authenticate(Authentication authentication) {
    ...
    AuthenticationHeaderToken authenticationResult =
        new AuthenticationHeaderToken(user, headerToken, user.getAuthorities());
