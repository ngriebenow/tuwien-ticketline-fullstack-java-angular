...
public class MessageSummaryMapper {
  ...
  private static final Pattern PATTERN =
      Pattern.compile("^(.{0," + NUMBER_OF_ALLOWED_CHARACTERS + "})(\\s|$)|.*$");

  /**
   * Intelligent trim of text to summary.
   *
   * <p>A summary can contain NUMBER_OF_ALLOWED_CHARACTERS characters. If it is longer it will be
   * stripped down to the last whitespace character or if there is not at exactly the maximum
   * length.
   *
